...
Lmotors.set_max_L_current(15)
Lmotors.set_max_R_current(15)
Lmotors.set_rated_L_current(6)
Lmotors.set_rated_R_current(6)

Rmotors.disable_motor()
Rmotors.enable_motor()
Rmotors.set_mode(4)
Rmotors.set_max_rpm(230)
Rmotors.set_max_L_current(15)
Rmotors.set_max_R_current(15)
Rmotors.set_rated_L_current(6)
Rmotors.set_rated_R_current(6)
